    ...
    details: [
      {
        ...
        longDescription: "深圳市嘉亨物流有限公司成立于2006年，主要从事全国范围内公路集装箱长短途运输及报关、仓储相关配套服务。公司总部位于深圳盐田，具备成熟的物流管理经验、稳定的车辆及司机资源、信息化调度管理能力和覆盖客户业务场景的配送服务基础。公司服务理念为“一诺必达、专业用心，24小时提供最优质的服务”。"
      },
      {
        label: "车辆资源",
        value: "自有厢式车、自备柜及货柜车，满足多样化车型需求。",
        longDescription: "公司自有厢式车、自备柜及货柜车资源，驾驶员经培训后上岗。吨车自备柜业务围绕接单准备、派车复核、装车离厂、在途跟踪、到仓卸货和回单归档实施标准化管理。进口业务以“提重还空”为核心，出口业务围绕提空柜、工厂装货、报关衔接、还重柜、资料整理实施标准化管理，满足不同车型、柜型和时效需求。"
      },
      {
        label: "保险保障",
        value: "全额物流责任险，可针对高价值货物提供专项加保。",
        longDescription: "公司为运输业务投保物流责任保险，并可按货值增加临时高价值货物投保安排。针对冷藏/温控货物，确认温控要求、车辆条件、装卸等待时间和保险条款，可根据客户产品价值和运输要求增加保险安排。针对高价值货物，运输前确认货值、路线、车辆、停车点和临时投保需求，可按项目申请单次临时投保，降低运输风险和客户损失。"
      },
    ]
  },
  {
    ...
    details: [
      {
        ...
        longDescription: "码头柜出口作业程序包括：接单与订舱资料（核对Booking、柜型、截关时间、装货地址、报关资料，单证不齐不得进入派车）；提空柜（检查柜体清洁、破损、异味、漏水、柜门开闭状态，不合格柜体不得装货）；工厂装货（监控货物包装、数量、重心、封柜和铅封记录，封号应与资料一致）；报关衔接（确认司机本、司机纸、报关资料移交和放行状态）；还重柜（按预约窗口还柜，取得码头签收或系统状态，错过截关立即升级处理）；资料整理（设备交接单、提柜单回联、Booking、报关资料按客户装订归档，当日移交财务和单证，账不过夜）。"
      },
      {
        label: "码头柜进口",
        value: "船舶动态确认 → 提柜资料核对 → 码头提柜 → 卸货安排 → 空柜返还。",
        longDescription: "码头柜进口作业程序包括：船舶动态确认（确认到港时间、可提柜时间、港区和船公司要求，到港异常及时调整派车计划）；提柜资料核对（核对柜号、提柜单、设备交接单、船公司和港区信息，信息不一致暂停提柜）；码头提柜（按预约时间提柜，检查柜体外观和封条状态，柜体异常要求码头开具证明）；运输至工厂/仓库（按路线执行并反馈到达、卸货、离厂节点，延误影响免租期时提前预警）；空柜返还（按客户或船公司要求返还空柜并取得交接资料，港区拥堵或返空延误及时同步客户）。"
      },
      {
        label: "特殊业务",
        value: "机场提货、冷藏温控、高价值货物及多点装卸专项控制。",
        longDescription: "特殊业务控制要求包括：机场提货（按机场现场要求提货，提醒驾驶员核对外包装和数量，异常即时拍照并汇报）；冷藏/温控货物（确认温控要求、车辆条件、装卸等待时间和保险条款，可根据客户产品价值和运输要求增加保险安排）；高价值货物（运输前确认货值、路线、车辆、停车点和临时投保需求，可按项目申请单次临时投保）；多点装卸（接单阶段确认各点顺序、时间窗口、费用承担和联系人，多点产生费用应提前确认）；异地报关/转关（核查司机本、IC卡、准载证、载货清单等资料，资料缺失不得出车或进场操作）。"
      },
    ]
  },
  {
    ...
    details: [
      {
        ...
        longDescription: "驾驶员是运输任务现场执行的直接责任主体。公司应对驾驶员开展安全驾驶、客户操作流程、港区/仓库现场规则、单证交接、异常上报、货物防盗和服务沟通培训。安全驾驶培训涵盖酒后禁驾、疲劳驾驶防控、雨天/涉水/隧道/铁路道口行车要求，入职及季度复训。现场作业培训涵盖停放、熄火、三角木、监装监卸、封条和柜体检查，项目导入及月度抽查。异常处理培训涵盖货损货差、车辆故障、交通事故、盗抢、压夜、返空处理，半年演练或案例复盘。重点客户或特殊业务应进行专项操作交底。"
      },
      {
        label: "车辆检查",
        value: "机油、制动、轮胎、灯光、方向等每日出车前必检。",
        longDescription: "出车前车辆检查项目包括：机油/冷却水/刹车油/燃料（确认充足，无漏油、漏水现象，不足或泄漏时不得出车）；皮带与发电设备（检查风扇皮带、冷气机和发电机皮带松紧程度，异常需维修确认）；轮胎与轮毂（轮胎气压正常，轮毂螺丝无松动，存在明显磨损或松动时处理后出车）；灯光/喇叭/雨刮（设备齐全且工作良好，夜间或雨天必须恢复后出车）；制动与方向（刹车和方向有效，仪表无异常报警，存在故障立即停运报修）。"
      },
      {
        label: "行车安全",
        value: "严禁酒驾疲劳驾驶，涉水路段及特殊地形专项指引。",
        longDescription: "行车与停放安全要求包括：车辆起步（发动前拉紧手制动、变速杆置于空档；起步前观察前后左右行人和障碍物，在装卸场地或不熟悉环境应绕车一周确认安全）；行车过程（集中精神驾驶，不吸烟、饮食、闲谈；严禁酒后驾驶、熄火滑行、雨天高速空档滑行和强行超车）；涉水路段（先了解水情，水面超过轮胎三分之二以上不得通过；涉水后低速轻踏制动恢复制动效果）；铁路/隧道/高架（铁路道口提前减速观察，严禁抢行；通过隧道、高架时注意限高标识并准确通过）；途中停车（选择安全位置，不影响其他车辆；检修时靠右停放、开启警示灯、摆放危险标志并熄火）；过夜停车（车辆在外过夜或带货过夜，应停放在安全有保障的单位或停车场，车尾对尾或车尾对墙，防止货物被盗）。"
      },
    ]
  },
  {
    ...
    details: [
      {
        ...
        longDescription: "公司车辆配备GPS并结合系统记录、电子屏幕监控和调度跟踪机制，对车辆到厂、离厂、在途、到仓等关键节点进行可视化管理。订单基础信息包括客户、订单号、柜号、柜型、装卸地址、联系人、时间窗口，用于建立运输任务唯一标识。派车信息包括车辆、驾驶员、电话、候命地点、取单时间，保证资源匹配和责任落实。运输节点包括到厂、装货、离厂、到仓、签收、返空/还柜时间，支撑时效控制和客户查询。异常信息包括异常类型、原因、处理措施、客户同步、费用影响，支撑复盘和结算。单证资料包括提柜单、设备交接单、签收单、费用票据、照片，保证可追溯和可审核。"
      },
      {
        label: "数据透明",
        value: "节点报表、异常记录、项目KPI统计定时推送。",
        longDescription: "公司对外可根据客户要求提供运输状态反馈、节点报表、异常记录和项目KPI统计。服务质量指标包括：节点反馈及时率≥95%（到厂、离厂、到仓、签收等节点按要求反馈的比例，保证运输透明）；单证完整率≥98%（按单完整回收并归档的运输任务比例，支撑费用结算和客户审核）；异常响应启动30分钟内（发现异常至调度启动处理并同步相关方的时间，降低客户风险感知）；客户投诉回复24小时内（投诉收到至首次正式回复的时间，提升服务感知）；费用确认留痕率100%（压夜、返空、高速、多点等费用取得客户确认的比例，减少结算争议）。"
      },
      {
        label: "信息安全",
        value: "严格的数据访问权限管理，确保客户资料安全。",
        longDescription: "订单资料、客户信息、司机信息、报关资料、费用资料和影像记录均属于公司运营数据，应按照岗位权限和业务需要进行访问和保存。对客户提供的项目资料不得擅自外传；对投标、审厂或客户审核所需资料，应由指定窗口统一提供。公司持续推进流程化、规范化管理，并通过质量管理体系相关认证，提高服务一致性与可审核性。"
      },
    ]
  }
];
                  ...
                  <div className="flex flex-col relative">
                    ...
                    <div className="p-12 bg-white">
                      <DialogDescription className="text-slate-500 text-base leading-relaxed">
                        {(selectedManagementDetail.detail as any).longDescription || selectedManagementDetail.detail.value}
                      </DialogDescription>
                    </div>
                  </div>
                )}
