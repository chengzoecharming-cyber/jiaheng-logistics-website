...
const MANAGEMENT_MODULES = [
  {
    ...
    details: [
      { label: "管理经验", value: "多年物流运营背景，岗位分工清晰，确保项目稳健导入。" },
      { label: "车辆资源", value: "自有厢式车、自备柜及货柜车，满足多样化车型需求。" },
      { label: "保险保障", value: "全额物流责任险，可针对高价值货物提供专项加保。" },
    ]
  },
  {
    id: "mod2",
    ...
    details: [
      { label: "码头柜出口", value: "提空柜检查 → 工厂装货 → 报关衔接 → 还重柜 → 资料整理。" },
      { label: "码头柜进口", value: "船舶动态确认 → 提柜资料核对 → 码头提柜 → 卸货安排 → 空柜返还。" },
      { label: "特殊业务", value: "机场提货、冷藏温控、高价值货物及多点装卸专项控制。" },
    ]
  },
  {
    id: "mod3",
    ...
    details: [
      { label: "驾驶员管理", value: "准入审核、季度安全培训、事故后专项复训。" },
      { label: "车辆检查", value: "机油、制动、轮胎、灯光、方向等每日出车前必检。" },
      { label: "行车安全", value: "严禁酒驾疲劳驾驶，涉水路段及特殊地形专项指引。" },
    ]
  },
  {
    id: "mod4",
    ...
    details: [
      { label: "实时监控", value: "车辆位置、在途状态、异常停留实时预警。" },
      { label: "数据透明", value: "节点报表、异常记录、项目KPI统计定时推送。" },
      { label: "信息安全", value: "严格的数据访问权限管理，确保客户资料安全。" },
    ]
  }
];
