    ...
    details: [
      {
        ...
        longDescription: "嘉亨物流拥有超过20年的公路集装箱运输管理经验，核心团队成员均来自大型物流企业与港口集团。我们建立了清晰的组织架构：运营部负责项目整体统筹，调度中心负责车辆实时派单与在途跟踪，安全部负责驾驶员培训与车辆检查，客服部负责节点反馈与客户沟通。这种岗位分工确保了从客户询盘、合同签订、项目导入到日常运营的全流程可控，能够快速响应客户需求并在项目启动阶段即完成风险评估与资源配置。"
      },
      {
        label: "车辆资源",
        value: "自有厢式车、自备柜及货柜车，满足多样化车型需求。",
        longDescription: "公司自有多种类型运输车辆，包括标准厢式货车、自备柜拖车及码头货柜车，可满足不同尺寸、不同载重、不同港区的多样化车型需求。所有车辆均配备GPS定位系统与行车记录仪，定期进行保养与年检。此外，我们还与多家优质车队建立了长期战略合作关系，在旺季或特殊项目期间能够迅速调配备用运力，确保“一诺必达”的服务承诺不被运力瓶颈所限制。"
      },
      {
        label: "保险保障",
        value: "全额物流责任险，可针对高价值货物提供专项加保。",
        longDescription: "我们为每一票运输业务投保全额物流责任险，基础保额可覆盖常规货物的全程运输风险。针对电子产品、精密仪器、高价值奢侈品等特殊货物，可在标准保单基础上进行专项加保，提供从提货、在途到交付的全链条风险保障。同时，公司建立了货损货差快速理赔通道，与保险公司实现了线上资料直传，确保事故发生后能够在最短时间内完成定损与赔付，最大程度降低客户的经济损失。"
      },
    ]
  },
  {
    ...
    details: [
      {
        ...
        longDescription: "码头柜出口SOP涵盖五个核心环节：提空柜检查（核对柜号、检查柜体完好性、确认锁具齐全）、工厂装货（按预约时间到达、监督装货过程、拍照留证、核对毛重与封条号）、报关衔接（与报关行实时同步资料、确认放行信息）、还重柜（按船期窗口准时还柜、获取码头回执）、资料整理（汇总提单、设备交接单、装箱单等单证并移交客户）。每个环节都设置了时间节点与责任人，确保出口货物准时上船。"
      },
      {
        label: "码头柜进口",
        value: "船舶动态确认 → 提柜资料核对 → 码头提柜 → 卸货安排 → 空柜返还。",
        longDescription: "进口作业从船舶动态确认开始：客服团队每日跟踪船期与到港信息，提前一天向客户发送到货通知。随后进行提柜资料核对（提单、设备交接单、放货指令），安排车辆按预约时段进入码头提柜。货物到达工厂后，监督卸货并核对数量与包装完整性，最后按港区要求在规定时间内返还空柜，避免产生滞箱费。整个流程由调度中心实时监控，确保进口货物从码头到工厂的无缝衔接。"
      },
      {
        label: "特殊业务",
        value: "机场提货、冷藏温控、高价值货物及多点装卸专项控制。",
        longDescription: "针对机场提货、冷藏温控、高价值货物及多点装卸等特殊场景，我们制定了专项控制流程。机场提货需提前预约航班信息、核对航空运单与报关资料；冷藏货物全程监控车厢温度并每30分钟记录一次；高价值货物实行双人押运、全程封闭车厢、指定路线行驶；多点装卸则按客户提供的清单逐点核对装卸数量与签收单据，确保每一站都不遗漏、不错装。"
      },
    ]
  },
  {
    ...
    details: [
      {
        ...
        longDescription: "驾驶员准入实行“三证一检”制度（身份证、驾驶证、从业资格证加背景调查），确保人员资质合规。入职后须参加公司组织的季度安全培训，内容涵盖交通法规更新、典型事故案例分析、防御性驾驶技巧及客户服务礼仪。对于发生过交通事故的驾驶员，实行“停岗复训”机制：必须完成不少于8课时的专项安全复训并通过考核后方可重新上岗。所有培训记录与考核结果均建档留存。"
      },
      {
        label: "车辆检查",
        value: "机油、制动、轮胎、灯光、方向等每日出车前必检。",
        longDescription: "每辆车在每日出车前必须完成“机油、制动、轮胎、灯光、方向”五项必检。驾驶员通过公司统一的车辆出车检查表逐项确认并拍照上传至调度群，调度中心对异常情况进行复核与处置。除了日检，公司还实行周保养与月检修制度，重点检查发动机工况、刹车片磨损、轮胎花纹深度及悬挂系统状态，确保车辆始终处于最佳技术状态，杜绝带病上路。"
      },
      {
        label: "行车安全",
        value: "严禁酒驾疲劳驾驶，涉水路段及特殊地形专项指引。",
        longDescription: "公司严禁驾驶员酒后驾车、疲劳驾驶及超速行驶，所有车辆均安装GPS与ADAS驾驶行为监测系统，对急刹、急转、超速等危险行为实时预警。针对暴雨天气涉水路段、山区弯道、夜间行车等特殊地形与时段，制定了专项行车指引：如涉水前确认水深不超过轮胎半径三分之一、山区行驶保持低速档位、夜间行车增加跟车距离等。安全部每周对GPS数据进行抽查，对违规驾驶员进行约谈与处罚。"
      },
    ]
  },
  {
    ...
    details: [
      {
        ...
        longDescription: "依托GPS定位系统与车载视频监控，调度中心能够实时掌握所有车辆的地理位置、行驶速度、在途状态及车厢内画面。系统设置了电子围栏与异常停留预警：当车辆偏离预定路线或在没有报备的情况下停留超过15分钟时，系统会自动向调度员发送短信与App推送，调度员将在5分钟内致电驾驶员核实情况，必要时启动应急响应机制，确保货物运输全程可控。"
      },
      {
        label: "数据透明",
        value: "节点报表、异常记录、项目KPI统计定时推送。",
        longDescription: "公司建立了标准化的数据报表体系，每日向客户推送运输节点报表（包括发车时间、到达时间、装卸完成时间、异常停留记录等），每周汇总异常记录与处理结果，每月提供项目KPI统计报告（节点反馈及时率、单证完整率、准时到达率、客户投诉率等）。所有数据均来源于GPS系统与驾驶员的实时上报，确保客观、真实、可追溯，为客户优化供应链决策提供数据支持。"
      },
      {
        label: "信息安全",
        value: "严格的数据访问权限管理，确保客户资料安全。",
        longDescription: "公司实行严格的数据访问权限分级管理：驾驶员只能查看与自己相关的派车单信息，调度员只能访问所负责客户的订单数据，管理层才能查看全量运营报表。所有客户资料、合同文本、运价信息均存储在加密服务器中，定期进行数据备份与漏洞扫描。员工入职时须签署保密协议，离职时立即收回系统账号，从制度与技术两个层面确保客户商业资料的安全。"
      },
    ]
  }
];
