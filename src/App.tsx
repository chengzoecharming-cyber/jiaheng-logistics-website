...
const MANAGEMENT_MODULES = [
  ...
  },
  {
    ...
    details: [
      ...
      {
        label: "码头柜进口",
        value: "船舶确认 →  资料核对 →码头提柜 → 卸货安排 → 空柜返还",
        bullets: [
                        ...
                        >
                          <CardContent className="p-8 flex items-start gap-5">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-slate-500 leading-relaxed text-sm whitespace-pre-line">{detail.value}</p>
                            </div>
                          </CardContent>
                        </Card>
                      ))}
